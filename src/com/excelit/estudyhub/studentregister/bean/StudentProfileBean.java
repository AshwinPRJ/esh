...
@Entity
@Table(name = "esh_studnetprofile", schema = DBconstants.SCHEMA_NAME)
public class StudentProfileBean implements Serializable{
	@Id
	@Column(name = "studnetprofile_registrationid", length = 11)
	private String studentRegistrationId;

	@Column(name = "studnetprofile_firstname", length = 20)
	private String studentFirstName;

	@Column(name = "studnetprofile_middlename", length = 20)
	private String studentMiddleName;

	@Column(name = "studnetprofile_lastname", length = 20)
	private String studentLastName;

	@Column(name = "studnetprofile_preferredname", length = 30)
	private String studentPreferredName;

	@Column(name = "studnetprofile_gender", length = 1)
	private String gender;

	@Column(name = "studnetprofile_dob")
	private Date studentDateOfBirth;

	@Column(name = "studnetprofile_placeofbirth", length = 70)
	private String studentPlaceOfBirth;

	@Column(name = "studnetprofile_studentrace", length = 50)
	private String studentRace;

	@Column(name = "studnetprofile_studentlivewith", length = 30)
	private String studentLiveWith;

	@Column(name = "studnetprofile_aadharcard", length = 15)
	private String studentAadharCard;

	@Column(name = "studnetprofile_religion", length = 40)
	private String studentReligion;

	@Column(name = "studnetprofile_caste", length = 50)
	private String studentCaste;

	@Column(name = "studnetprofile_category", length = 50)
	private String studentCategory;

	@Column(name = "studnetprofile_rtecandidate", length = 1)
	private String studentRTECandidate;

	@Column(name = "studnetprofile_addressline1", length = 50)
	private String studentAddressLine1;

	@Column(name = "studnetprofile_addressline2", length = 50)
	private String studentAddressLine2;

	@Column(name = "studnetprofile_addressline3", length = 50)
	private String studentAddressLine3;

	@Column(name = "studnetprofile_city", length = 50)
	private String studentCityOrTown;

	@Column(name = "studnetprofile_district", length = 60)
	private String studentDistrict;

	@Column(name = "studnetprofile_state", length = 50)
	private String studentState;

	@Column(name = "studnetprofile_country", length = 50)
	private String studentCountry;

	@Column(name = "spd_postal_code", length = 15)
	private Integer studentPostalOrZipCode;

	@Column(name = "studnetprofile_home_phone_number", length = 20)
	private Integer studentHomePhoneNumber;

	@Column(name = "studnetprofile_mob", length = 20)
	private Integer studentMobileNumber;

	@Column(name = "studnetprofile_email", length = 20)
	...
	/**
	 * @param studentCityOrTown the studentCityOrTown to set
	 */
	...
	/**
	 * @param studentDistrict the studentDistrict to set
	 */
	...
	/**
	 * @param studentPostalOrZipCode the studentPostalOrZipCode to set
	 */
